...
git add . : 현재 변경사항 커밋할 목록에 추가

git commit -m "커밋 메시지" : 커밋

git push : 생성된 커밋들 반영하기

git config --global user.name "John"

git status : 현재 변경사항과 add 가능한 목록 표시

git credential reject : 권한 삭제
...
![image-20220521234643532](C:\Users\user\AppData\Roaming\Typora\typora-user-images\image-20220521234643532.png)