...
const result = forEach(color => console.log(color))
console.log(result)
...
function handlePosts(){
  const posts = [
    ...
    {id:52, title: 'josun'},
    {id:105, title: 'The Brigtest Ruby'},
  ]
...
// total -> 누적값
// x -> 초기값(option)
const sum = ssafyTests.reduce((total, x) => total += x, 0) //초기값 0
console.log(sum)
...
const admin = PEOPLE.find(function(user){
  return user.admin === true
})
console.log(admin)
