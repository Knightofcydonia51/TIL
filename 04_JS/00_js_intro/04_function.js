...
console.log(ssafy1('ted'))

//2. ()생략할 수 있다!(인자가 1개 있을때)
const ssafy1 = name => {return `Hello! ${name}`}
console.log(ssafy1('John'))
...
// 5-2. return을 적지않고 object를 return하고 싶다면 ()를 활용
...
ssafy2() // 2. 함수 호출 -> ssafy2가 초기화가 됐나유?
...
check_long_str= function(string){
  if(string.length>10){
      return true
  }else{
      return false
